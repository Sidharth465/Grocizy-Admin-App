  ...
  return (
    <Drawer.Navigator  drawerContent={props=><CustomDrawer {...props}/>}>
      ...
      <Drawer.Screen
        ...
        options={{headerTitleAlign: 'center',
        headerShown:false,
        headerRight:()=>(<TouchableOpacity onPress={()=><ProductModal isVisible={true}/>} style={{marginRight:15,padding:5,borderRadius:5,backgroundColor:"#fff",elevation:10,shadowColor:"#fff"}}>
